class HomeArticleBean {
  ...
  HomeArticleBean.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? new DataBean.fromJson(json['data']) : null;
...
class DataBean {
  ...
  DataBean(this.curPage, this.datas, this.offset, this.over, this.pageCount, this.size, this.total);

  DataBean.fromJson(Map<String, dynamic> json) {
    curPage = json[curPage];
    if (json['datas'] != null) {
      datas = new List<ArticleData>();
