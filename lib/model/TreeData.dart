...
class TreeData {
  ...
  int errorCode;
  String errorMsg;
  List<FathersBean> data;

  TreeData.fromParams({this.errorCode, this.errorMsg, this.data});

  factory TreeData(jsonStr) => jsonStr == null ? null : jsonStr is String ? new TreeData.fromJson(json.decode(jsonStr)) : new TreeData.fromJson(jsonStr);

  TreeData.fromJson(jsonRes) {
    errorCode = jsonRes['errorCode'];
    errorMsg = jsonRes['errorMsg'];
    data = jsonRes['data'] == null ? null : [];

    for (var dataItem in data == null ? [] : jsonRes['data']){
      data.add(dataItem == null ? null : new FathersBean.fromJson(dataItem));
    }
  }
...
class FathersBean {
  ...
  FathersBean.fromParams({this.courseId, this.id, this.order, this.parentChapterId, this.visible, this.userControlSetTop, this.name, this.children});

  FathersBean.fromJson(jsonRes) {
    ...
    for (var childrenItem in children == null ? [] : jsonRes['children']){
      children.add(childrenItem == null ? null : new ChildrenBean.fromJson(childrenItem));
    }
  }
...
class ChildrenBean {
  ...
  ChildrenBean.fromParams({this.courseId, this.id, this.order, this.parentChapterId, this.visible, this.userControlSetTop, this.name, this.children});

  ChildrenBean.fromJson(jsonRes) {
    courseId = jsonRes['courseId'];
    id = jsonRes['id'];
    order = jsonRes['order'];
    parentChapterId = jsonRes['parentChapterId'];
...
class TreeArticle {
  ...
  TreeArticle.fromParams({this.errorCode, this.errorMsg, this.data});

  factory TreeArticle(jsonStr) => jsonStr == null ? null : jsonStr is String ? new TreeArticle.fromJson(json.decode(jsonStr)) : new TreeArticle.fromJson(jsonStr);

  TreeArticle.fromJson(jsonRes) {
    errorCode = jsonRes['errorCode'];
    errorMsg = jsonRes['errorMsg'];
    data = jsonRes['data'] == null ? null : new ArticleData.fromJson(jsonRes['data']);
  }
...
class ArticleData {
  ...
  ArticleData.fromParams({this.curPage, this.offset, this.pageCount, this.size, this.total, this.over, this.datas});
